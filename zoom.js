...
var zoomPerformed = false;
       ...
       clickTarget.on("click touchend", function(evt) {
    if (!zoomPerformed) {
...
// Reset zoomPerformed flag on touchstart or mousedown
clickTarget.on("mousedown touchstart", function() {
    zoomPerformed = false;
});
...
(function($) {
    ...
    if(performZoom) {
        // Simulate click to trigger zoom
...
function ZoomFunc(dataAccText) {
  let div = document.querySelector(`[data-acc-text='${dataAccText}']`);
  $(div).zoomTarget();
